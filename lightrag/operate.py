    ...
    def rerank(data):
        ...
        def get_top_k_results(data, query, reranker, k=10):
            ...
            for item in data:
                ...
                item['score'] = scores[0]  # 将分数添加到每个条目  添加一列
        ...
        #     r'F:\CODE\项目2\project2\LightRAG\BAAI\bge-reranker-v2-m3',
        #     use_fp16=True)


        # 使用微调后的reranker模型
        reranker = FlagReranker(
            r'F:\CODE\项目2\project2\InternalMedicine-RAG\BAAI\checkpoint-112',
            use_fp16=True)
...
async def _get_edge_data(
    ...
    def rerank(data):
        ...
        def get_top_k_results(data, query, reranker, k=10):
            ...
            for item in data:
                # 拼接成字符串
                combined_str = create_combined_str(item)
